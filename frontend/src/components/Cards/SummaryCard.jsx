        ...
        >
            ...
            <div className="px-3 pb-3">
                <div className="flex items-center gap-3 mt-4">
                    <div className="text-[12px] font-medium text-black px-3 py-1 border-[0.9px] border-black-900 rounded-full">
                ...
                <p className="text-[13px] text-gray-800 font-medium line-clamp-2 mt-3">
                    {description}
                </p>
            </div>
        </div>
